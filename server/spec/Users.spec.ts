...
import Stat, { IUser } from '@entities/User';
...
describe('Users Routes', () => {
    ...
    describe(`"GET:${getUsersPath}"`, () => {
        ...
        it(`should return a JSON object with all the users and a status code of "${OK}" if the
            ...
            const users = [
                new Stat('Sean Maxwell', 'sean.maxwell@gmail.com'),
                new Stat('John Smith', 'john.smith@gmail.com'),
                new Stat('Gordan Freeman', 'gordan.freeman@gmail.com'),
            ];
    ...
    describe(`"POST:${addUsersPath}"`, () => {
        ...
        const userData = {
            user: new Stat('Gordan Freeman', 'gordan.freeman@gmail.com'),
        };
